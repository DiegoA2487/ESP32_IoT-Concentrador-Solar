...
#include <adafruit_ina219_mock.h> //librería para el uso del sensor agregada en el gestor de bibliotecas
...
public:
    ...
    void updateData(float tempColector, float tempAmb, float humAmb, float radiacion, 
     ...
     void imprimirValores() { // para imprimir en consola al estilo tabla
        ...
        Serial.println("\n      TimeStamp          |   R    |   Tc   |   Ta   |   Ha   |    E   |   Ti   |   Fl   |  INA  ");
        Serial.printf("%s | %6.2f | %6.2f | %6.2f | %6.2f | %6.2f | %6.2f | %6.2f | %6.2f \n\n", timestamp.c_str(), R, Tc, Ta, Ha, E, Ti, Fl, INA);
    }
...
void loop() {
    ...
    // Declaración de variables para las lecturas
...
void adquirirDatosINA219() {
  // Adquisición de datos del sensor INA219
